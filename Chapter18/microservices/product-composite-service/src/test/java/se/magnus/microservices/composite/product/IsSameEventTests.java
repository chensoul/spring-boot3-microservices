...
class IsSameEventTests {
  ...
  void testEventObjectCompare() throws JsonProcessingException {
    ...
    Event<Integer, Product> event1 = new Event<>(CREATE, 1, new Product(1, "name", 1));
    Event<Integer, Product> event2 = new Event<>(CREATE, 1, new Product(1, "name", 1));
    Event<Integer, Product> event3 = new Event<>(DELETE, 1, null);
    Event<Integer, Product> event4 = new Event<>(CREATE, 1, new Product(2, "name", 1));
